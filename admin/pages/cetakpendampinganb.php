...
$query = "SELECT id_damping,create_by,tanggal,detail_damping,status,keterangan,update_by FROM pendampingan ORDER BY id_damping";
...
$judul = "LAPORAN DATA PENDAMPINGAN";
$header = array(
