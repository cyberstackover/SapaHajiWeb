...
$query = "SELECT * FROM danaspm ORDER BY id_dspm";
...
while ($row = mysql_fetch_assoc($sql)) {
	...
	$output .= '<tr>  
                  <td width="3%">'.$i.'</td>  
                  <td width="3%">'.$row["id_dspm"].'</td>  
                  <td width="15%">Nama : '.$namam.'<br>Id Member : '.$row["create_by"].'<br>Email : '.$emailm.'</td>
                  <td width="7%">'.$row["tanggal"].'</td>  
                  <td width="30%">'.$row["detail_dspm"].'</td>  
                  <td width="7%"><img src="http://si-mice.com/simice/files/pic/danaspm/'.$row["dspmpic"].'" border="0" height="50" width="50" /></td>   
                  <td width="15%">'.$row["dspmfile"].'</td>  
...
require_once('tcpdf/tcpdf.php');  
      ...
      $obj_pdf->SetTitle("Laporan Data Pengajuan Proposal Dana SPM Aplikasi SI - MICE");  
      ...
      $content = '';  
      $content .= '  
      <h1 align="center">Laporan Data Pengajuan Proposal Dana SPM Aplikasi SI - MICE</h1><br /><br />  
      <table border="1" cellspacing="0" cellpadding="5"> 
      	<thead> 
           <tr style="border: 1px solid black; background-color: #EEE;">  
                ...
                <th width="15%"><strong>Nama FIe Proposal</strong></th>  
      ...
      $obj_pdf->Output('dataDanaSPMdSIMICE.pdf', 'I');
?>