...
$query1=mysql_query("select * from pengaduan where id_adu = ".$_GET['id']);
	      ...
	      <div class="box box-info">
	        ...
	        <div class="box-body">
	          ...
	          <input type="hidden" name="id" value="<?php echo $_GET['id']; ?>">
	           <input type="hidden" name="type" value="data_pengaduan">
	            ...
	            <a href="index.php?page=data_pengaduan" class="btn btn-danger"> <i class="fa fa-times"></i>  Batal</a>
	          </form>
	        </div><!-- /.box-body -->
	      </div><!-- /.box -->
	    </div><!--/.col (right) -->
