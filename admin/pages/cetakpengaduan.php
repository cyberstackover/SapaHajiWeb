...
$query = "SELECT * FROM pengaduan ORDER BY id_adu";
...
while ($row = mysql_fetch_assoc($sql)) {
	...
	$output .= '<tr>  
                  <td width="3%">'.$i.'</td>  
                  <td width="3%">'.$row["id_adu"].'</td>  
                  <td width="15%">Nama : '.$namam.'<br>Id Member : '.$row["create_by"].'<br>Email : '.$emailm.'</td>  
                  <td width="10%">'.$row["category"].'</td>  
                  <td width="5%">'.$row["jenis"].'</td> 
                  <td width="20%">'.$row["detail_adu"].'</td>  
                  <td width="7%"><img src="http://si-mice.com/simice/files/pic/pengaduan/'.$row["adupic"].'" border="0" height="50" width="50" /></td>   
                  <td width="7%">'.$row["tanggal"].'</td>  
                  <td width="12%">'.$row["lokasi"].'</td>  
...
require_once('tcpdf/tcpdf.php');  
      ...
      $obj_pdf->SetTitle("Laporan Data Pengaduan Aplikasi SI - MICE");  
      ...
      $content = '';  
      $content .= '  
      <h1 align="center">Laporan Data Pengaduan Aplikasi SI - MICE</h1><br /><br />  
      <table border="1" cellspacing="0" cellpadding="5"> 
      	<thead> 
           <tr style="border: 1px solid black; background-color: #EEE;">  
                ...
                <th width="5%"><strong>Jenis</strong></th>  
                <th width="20%"><strong>Deskripsi</strong></th>
                <th width="7%"><strong>Foto / Bukti</strong></th>  
      ...
      $obj_pdf->Output('datapengaduanSIMICE.pdf', 'I');
?>