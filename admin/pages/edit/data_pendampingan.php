...
$query1=mysql_query("select * from pendampingan where id_damping = ".$_GET['id']);
		...
		<div class="col-md-12">
	      ...
	      <div class="box box-info">
	        <div class="box-header">
	          <h3 class="box-title">Edit Data Pendampingan</h3>
	        </div><!-- /.box-header -->
	        <div class="box-body">
	          <form role="form" method="post" action="simpan.php">
	          <input type="hidden" name="idad" value="<?php echo $data['id']; ?>">
	          <input type="hidden" name="id" value="<?php echo $_GET['id']; ?>">
	           <input type="hidden" name="type" value="data_pendampingan">
	            ...
	            <div class="form-group">
	              ...
	              <textarea class="form-control" rows="3" name="deskripsi" placeholder="Keterangan Pendampingan" required="" ><?php echo $data1['keterangan']; ?></textarea>
	            </div>

	            <button type="submit" class="btn btn-success"> <i class="fa fa-save"></i> Simpan</button>
	            <button type="reset" class="btn btn-warning"> <i class="fa fa-backward"></i> Kembalikan Data</button>
	            <a href="index.php?page=data_pendampingan" class="btn btn-danger"> <i class="fa fa-times"></i>  Batal</a>
	          </form>
	        </div><!-- /.box-body -->
	      </div><!-- /.box -->
	    </div><!--/.col (right) -->
