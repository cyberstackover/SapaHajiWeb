	        ...
	        <div class="box-body">
	          <form role="form" method="post" action="simpan.php" enctype="multipart/form-data">
	            ...
	            <div class="form-group">
	              ...
	              <input type="text" class="form-control" name="judul" placeholder="Judul Pengumuman" value="" required="" />
	            </div>
	           	<div class="form-group">
	              <label>Foto / Banner</label>
	              <input type="file" class="form-control" name="ImageFile" placeholder="foto" value="" required="" />
	            </div>
	            <!-- textarea -->
	            <div class="form-group">
	              <label>Deskripsi Pengumuman</label>
	              <textarea class="form-control" rows="3" name="deskripsi" placeholder="Deskripsi Pengumuman" required="" ></textarea>
	            </div>
