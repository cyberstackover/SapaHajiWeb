...
$query = "SELECT idinfo,tittle,detail_info,update_by,date_update FROM pengumuman ORDER BY idinfo";
...
$judul = "LAPORAN DATA PENGUMUMAN";
$header = array(
		array("label"=>"ID", "length"=>10, "align"=>"L"),
		array("label"=>"JUDUL", "length"=>50, "align"=>"L"),
		array("label"=>"DETAIL", "length"=>160, "align"=>"L"),
		array("label"=>"ADMIN", "length"=>25, "align"=>"L"),
