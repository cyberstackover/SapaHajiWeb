...
$query1=mysql_query("select * from aduanbpjs where id_aduan = ".$_GET['id']);
		...
		<div class="col-md-12">
	      ...
	      <div class="box box-info">
	        <div class="box-header">
	          <h3 class="box-title">Edit Data Pengaduan BPJS</h3>
	        </div><!-- /.box-header -->
	        <div class="box-body">
	          <form role="form" method="post" action="simpan.php">
	          <input type="hidden" name="idad" value="<?php echo $data['id']; ?>">
	          <input type="hidden" name="id" value="<?php echo $_GET['id']; ?>">
	           <input type="hidden" name="type" value="data_aduanbpjs">
	            ...
	            <a href="index.php?page=data_aduanbpjs" class="btn btn-danger"> <i class="fa fa-times"></i>  Batal</a>
	          </form>
	        </div><!-- /.box-body -->
	      </div><!-- /.box -->
	    </div><!--/.col (right) -->
